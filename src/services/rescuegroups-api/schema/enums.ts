type Values<T> = T extends readonly (infer E)[] ? E : never;
...
export const exerciseNeedsValues = [
  "Not required",
  "Low",
  "Moderate",
  "High",
...
export const groomingNeedsValues = [
  "Not Required",
  "Low",
  "Moderate",
  "High",
...
export const indoorOutdoorValues = [
  "Indoor Only",
  "Indoor/Outdoor",
  "Outdoor Only",
] as const;
...
export const newPeopleReactionValues = [
  "Aggressive",
  "Protective",
  "Cautious",
  "Friendly",
...
export const obedienceTrainingValues = [
  "Needs Training",
  "Has Basic Training",
  "Well Trained",
] as const;
...
// use an arbitrary high number as a stand-in for unlimited.
